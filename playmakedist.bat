...
REM copy ffmpeg.exe dist\installdir
xcopy vlc dist\installdir\vlc /E /I

mkdir dist\installdir\config\production
copy config\production\default.cfg dist\installdir\config\production
copy config\log_client.conf dist\installdir\config
