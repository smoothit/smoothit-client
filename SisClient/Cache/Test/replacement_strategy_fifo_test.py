...
def test_ratemanagement_equal(conf):
    ...
    conf.set_base_directory("cache_tests/replacement_strategy_test/fifo/")
    conf.set_test_name("Ratemanagement test (fifo)")
    ...
    set_peers(conf, "cache_tests/replacement_strategy_test/fifo/", "SisClient/Cache/Test/config/config3.cfg")
