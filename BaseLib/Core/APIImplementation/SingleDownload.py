...
class SingleDownload:
    ...
    def __init__(self,infohash,metainfo,kvconfig,multihandler,get_extip_func,listenport,videoanalyserpath,vodfileindex,set_error_func,pstate,lmvodeventcallback,lmhashcheckcompletecallback,peer_type="-",
                 is_supporter_seed=False, supporter_ips =[]):
	    #SmoothIT_
    ...
    def hashcheck_done(self):
        ...
        try:
            print >>sys.stderr,"SingleDownload: supporter ips %s" % self.supporter_ips
