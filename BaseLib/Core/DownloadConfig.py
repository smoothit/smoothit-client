...
from BaseLib.Core.osutils import getfreespace, get_home_dir

# importing get_home_dir from BaseLib.Core.Session causes an
# ImportError...
def get_home_dir():
    from BaseLib.Core.Session import get_home_dir as session_get_home_dir
...
class DownloadConfigInterface:
    ...
    def set_peer_type(self,value):
        self.dlconfig['peer_type'] = value
        
    def get_peer_type(self):
        return delf.dlconfig['peer_type']
