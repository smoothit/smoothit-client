...
from BaseLib.Core.osutils import get_home_dir
GOTM2CRYPTO=False
try:
    import M2Crypto
...
class Session(SessionRuntimeConfig):
    ...
    def set_supporter_seed(self, is_supporter_seed):
        self._is_supporter_seed = is_supporter_seed
        
    def is_supporter_seed(self):
        return self._is_supporter_seed
    
    def set_supporter_ips(self, supporter_ips):
        self._supporter_ips = supporter_ips
        
    def get_supporter_ips(self):
        return self._supporter_ips