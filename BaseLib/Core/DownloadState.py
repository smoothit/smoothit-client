...
class DownloadState(Serializable):
    ...
    """
    def __init__(self,download,status,error,progress,stats=None,filepieceranges=None,logmsgs=None,coopdl_helpers=[],coopdl_coordinator=None,peerid=None,videoinfo=None,swarmcache=None,block_stats=None):
        ...
        @param block_stats statistics of blocks received since the last state (optional)  
        """
    ...
    def get_block_stats(self):
        '''
        Stats about blocks downloaded since the last download state was generated.
        @return: list of tupels (piece_index, block_offset, block_size, timestamp, sender_ip, sender_port, sender_id)
        '''
