...
# smoothit_
# added those fields to the hash (see detailed comment in BaseLib/Core/
# BitTornado/BT1/track.py in method track)
# (mgu)
trackerdefaults['minport'] = DEFAULTPORT
trackerdefaults['bind'] = []
trackerdefaults['ipv6_binds_v4'] = False
# _smoothit
...
dldefaults['max_uploads'] = 7 # note: max_upload slots are reserved for g2g and max_upload slots for t4t, so 2*max_uploads at all! (see Choker)
